...
class UserRepository extends dbOperation_1.DBOperation {
    ...
    getUserProfile(user_id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const addressResult = yield this.executeQuery(addressQueryString, addressValues);
    ...
    editProfile(user_id, { firstName, lastName, userType, address: { addressLine1, addressLine2, city, postCode, country, id }, }) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.updateUser(user_id, firstName, lastName, userType);
            const addressQueryString = 'UPDATE address SET address_line1=$1, address_line2=$2, city=$3, post_code=$4, country=$5 WHERE id=$6';
            const addressValues = [
                addressLine1,
                addressLine2,
                city,
